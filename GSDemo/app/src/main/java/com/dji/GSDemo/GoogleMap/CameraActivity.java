...
public abstract class CameraActivity extends Activity
    ...
    //Fråga användaren om det är tillåtet att använda kameran och minnet
    ...
    protected void setFragment() {
        ...
        // Pågrund utav att det blir problem med extend så måste vi fixa en annan lösning
        // Går det att skicka detta till ChalmersDemo direkt istället för att behöva köra override?
        cameraConnectionFragment.addConnectionListener((final Size size, final int rotation) ->
                CameraActivity.this.onPreviewSizeChosen(size, rotation));

        /*cameraConnectionFragment.addConnectionListener((final Size size, final int rotation) ->
                ChalmersDemo.onPreviewSizeChosen(size, rotation));
        */
